      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 shadow-2xl space-y-6 text-slate-900 dark:text-white transition-colors">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">アプリ・音声設定</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-slate-900 dark:text-white">女性ネイティブ</div>
                  <div className="text-[10px] text-slate-600 dark:text-slate-400 font-medium">US Female Voice</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                <User className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                <div className="text-left">
                  <div className="text-xs font-bold text-slate-900 dark:text-white">男性ネイティブ</div>
                  <div className="text-[10px] text-slate-600 dark:text-slate-400 font-medium">US Male Voice</div>
                </div>
              </div>
        ...
        <div className="space-y-3 pt-2 border-t border-slate-200 dark:border-slate-800">
          ...
          <label className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <div>
              <div className="text-xs font-bold text-slate-900 dark:text-white">問題切り替え時に自動再生</div>
              <div className="text-[11px] text-slate-600 dark:text-slate-400 font-medium">次の問題へ進んだ際、自動的に音声を流します</div>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <div>
              <div className="text-xs font-bold text-slate-900 dark:text-white">厳格判定モード (Strict Mode)</div>
              <div className="text-[11px] text-slate-600 dark:text-slate-400 font-medium">ピリオド、カンマ、大文字・小文字も厳密に判定します</div>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition">
            <div>
              <div className="text-xs font-bold text-slate-900 dark:text-white">頭文字ヒントを初期表示</div>
              <div className="text-[11px] text-slate-600 dark:text-slate-400 font-medium">各単語の先頭文字のヒントを表示します</div>
            </div>
            <input
              type="checkbox"
